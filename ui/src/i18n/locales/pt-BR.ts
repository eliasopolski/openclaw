...
export const pt_BR: TranslationMap = {
  ...
  quickSettings: {
    ...
    appearance: {
      ...
      lobsterdexCardShinySeen: "✦ Shiny visto em {date}",
  ...
  profilePage: {
    ...
    usageStatisticsDescription: "Veja atividade, custos e tendências de uso.",
    identity: {
      title: "Identidade",
  ...
  usage: {
    ...
    heatmap: {
      ...
      subtitle: "Intensidade diária de tokens no intervalo selecionado, até um ano.",
