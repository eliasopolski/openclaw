...
export const fa: TranslationMap = {
  ...
  custodian: {
    ...
    panel: {
      ...
      dockBottom: "قرار دادن Ask OpenClaw در پایین",
      dockRight: "قرار دادن Ask OpenClaw در سمت راست",
    },
    history: {
      button: "تاریخچه",
      title: "تغییرات اخیر",
  ...
  profilePage: {
    ...
    usageStatistics: "آمار مصرف",
    usageStatisticsDescription: "مشاهده فعالیت، هزینه‌ها و روند مصرف.",
    identity: {
      title: "هویت",
      menuLabel: "منوی هویت",
  ...
  chat: {
    ...
    composer: {
      ...
      fallbackActive: "جایگزین فعال: {model}",
      fallbackCleared: "پشتیبان پاک شد: {model}",
      fallbackSelected: "انتخاب‌شده: {model}",
      fallbackCurrent: "فعال: {model}",
      fallbackPrevious: "پشتیبان قبلی: {model}",
