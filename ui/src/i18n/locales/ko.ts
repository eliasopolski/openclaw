...
export const ko: TranslationMap = {
  ...
  quickSettings: {
    ...
    appearance: {
      ...
      lobsterdexCardShinySeen: "✦ Shiny 발견 {date}",
  ...
  profilePage: {
    ...
    usageStatisticsDescription: "활동, 비용 및 사용 추세를 확인합니다.",
    identity: {
      title: "ID",
      menuLabel: "ID 메뉴",
  ...
  usage: {
    ...
    heatmap: {
      title: "토큰 활동",
      subtitle: "선택한 범위의 일일 토큰 강도, 최대 1년까지.",
  ...
  cron: {
    adminRequired: "탐색 전용입니다. 자동화 변경에는 operator.admin 접근 권한이 필요합니다.",
    tabs: {
      filterLabel: "자동화 상태",
      all: "전체",
      active: "활성",
