...
export const nl: TranslationMap = {
  ...
  custodian: {
    ...
    panel: {
      ...
      resize: "Ask OpenClaw vergroten/verkleinen",
  ...
  usage: {
    ...
    heatmap: {
      ...
      subtitle: "Dagelijkse tokenintensiteit voor het geselecteerde bereik, tot maximaal één jaar.",
  ...
  chat: {
    ...
    composer: {
      ...
      compactingContext: "Context compacteren...",
      contextCompacted: "Context gecompacteerd",
      ...
      attachmentPreview: "Bijlagevoorbeeld",
  ...
  cron: {
    adminRequired: "Alleen bladeren. Automatiseringswijzigingen vereisen operator.admin-toegang.",
    tabs: {
