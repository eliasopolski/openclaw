...
export const ru: TranslationMap = {
  ...
  custodian: {
    ...
    panel: {
      ...
      dockBottom: "Закрепить Ask OpenClaw внизу",
  ...
  profilePage: {
    ...
    usageStatisticsDescription: "Просмотр активности, затрат и трендов использования.",
    identity: {
      title: "Профиль",
  ...
  usage: {
    ...
    heatmap: {
      ...
      subtitle: "Ежедневная интенсивность токенов за выбранный период, до одного года.",
  ...
  chat: {
    ...
    composer: {
      ...
      fallbackActive: "Резервный режим активен: {model}",
      fallbackCleared: "Резервный вариант очищен: {model}",
      fallbackSelected: "Выбрано: {model}",
      fallbackCurrent: "Активно: {model}",
      fallbackPrevious: "Предыдущий резервный вариант: {model}",
  ...
  cron: {
    adminRequired: "Только просмотр. Для изменений автоматизации требуется доступ operator.admin.",
    tabs: {
