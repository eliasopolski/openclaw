...
export const ja_JP: TranslationMap = {
  ...
  custodian: {
    ...
    panel: {
      ...
      dockBottom: "Ask OpenClaw を下部にドック",
      dockRight: "Ask OpenClaw を右側にドック",
    },
    history: {
      button: "履歴",
      title: "最近の変更",
  ...
  profilePage: {
    ...
    usageStatisticsDescription: "アクティビティ、コスト、使用傾向を表示します。",
    identity: {
      title: "アイデンティティ",
      menuLabel: "ID メニュー",
  ...
  usage: {
    ...
    heatmap: {
      title: "トークンアクティビティ",
      subtitle: "選択した範囲の日次トークン強度（最大1年間）。",
