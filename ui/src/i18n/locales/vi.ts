...
export const vi: TranslationMap = {
  ...
  usage: {
    ...
    heatmap: {
      ...
      subtitle: "Cường độ token hằng ngày cho phạm vi đã chọn, tối đa một năm.",
  ...
  chat: {
    ...
    messages: {
      ...
      actions: "Hành động tin nhắn",
      selectionActions: "Hành động lựa chọn",
      moreDetails: "Thêm chi tiết",
      askInSideChat: "Hỏi trong cửa sổ trò chuyện phụ",
      rewind: "Tua lại",
    ...
    composer: {
      ...
      fallbackPrevious: "Dự phòng trước: {model}",
