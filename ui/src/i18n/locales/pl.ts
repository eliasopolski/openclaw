...
export const pl: TranslationMap = {
  ...
  quickSettings: {
    ...
    appearance: {
      ...
      lobsterdexCardShinySeen: "✦ Shiny zauważony {date}",
  ...
  profilePage: {
    ...
    usageStatisticsDescription: "Zobacz aktywność, koszty i trendy użycia.",
    identity: {
      title: "Tożsamość",
  ...
  usage: {
    ...
    heatmap: {
      ...
      subtitle: "Dzienna intensywność tokenów dla wybranego zakresu, maksymalnie do jednego roku.",
  ...
  chat: {
    ...
    composer: {
      ...
      compactingContext: "Kompresowanie kontekstu...",
      contextCompacted: "Kontekst skompresowany",
      fallbackActive: "Aktywny tryb awaryjny: {model}",
      fallbackCleared: "Rezerwowy wyczyszczony: {model}",
      fallbackSelected: "Wybrano: {model}",
      fallbackCurrent: "Aktywny: {model}",
      fallbackPrevious: "Poprzedni rezerwowy: {model}",
