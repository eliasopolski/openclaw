...
export const de: TranslationMap = {
  ...
  chat: {
    ...
    messages: {
      ...
      askInSideChat: "Im Seiten-Chat fragen",
      rewind: "Zurückspulen",
    ...
    composer: {
      ...
      fallbackCleared: "Fallback entfernt: {model}",
  ...
  cron: {
    adminRequired: "Nur Ansicht. Automatisierungsänderungen erfordern operator.admin-Zugriff.",
    tabs: {
