...
export const uk: TranslationMap = {
  ...
  profilePage: {
    ...
    usageStatisticsDescription: "Переглядайте активність, витрати та тенденції використання.",
    identity: {
      title: "Ідентичність",
  ...
  usage: {
    ...
    heatmap: {
      ...
      subtitle: "Щоденна інтенсивність токенів за вибраний діапазон, до одного року.",
  ...
  chat: {
    ...
    messages: {
      ...
      selectionActions: "Дії з виділенням",
    ...
    composer: {
      ...
      contextCompacted: "Контекст стиснено",
      fallbackActive: "Резервний активний: {model}",
      fallbackCleared: "Резервний варіант очищено: {model}",
      fallbackSelected: "Вибрано: {model}",
      fallbackCurrent: "Активний: {model}",
      fallbackPrevious: "Попередній резервний варіант: {model}",
