...
export const es: TranslationMap = {
  ...
  quickSettings: {
    ...
    appearance: {
      ...
      lobsterdexCardShinySeen: "✦ Shiny detectado {date}",
  ...
  profilePage: {
    ...
    usageStatisticsDescription: "Ver actividad, costos y tendencias de uso.",
    identity: {
      title: "Identidad",
  ...
  cron: {
    adminRequired:
      "Solo exploración. Los cambios de automatización requieren acceso operator.admin.",
    tabs: {
